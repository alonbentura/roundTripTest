...
export class Result extends React.Component {
  ...
  render() {
    return (
      <div class="row" style={{ backgroundColor: 'white', height: 170, marginBottom: 10, marginRight: '-15px', direction: 'rtl', padding: 10 }}>

        <div class="col-9" >
          <div style={styles.hotelName}>{this.props.deal.hotelName}</div>
          <div class="row">
            <img class="col-3" alt='' style={{
              height: 100,
              objectFit: 'fill'
            }} src={this.props.deal.img}></img>
            <div class="col-6" style={styles.details}>
